...
CREATE TABLE `Reminder_Table` (
  `Reminder_Table_id` int(11) NOT NULL AUTO_INCREMENT,
  `Reminder_info` varchar(100) NOT NULL DEFAULT '',
  `R_date` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`Reminder_Table_id`)
...
LOCK TABLES `Reminder_Table` WRITE;
...
-- Dump completed on 2019-02-06 18:29:27
